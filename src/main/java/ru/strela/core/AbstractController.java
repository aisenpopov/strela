...
public abstract class AbstractController extends AjaxUpdater {
    ...
    protected void initBinder(WebDataBinder binder) throws Exception {
        ...
        binder.registerCustomEditor(Country.class, "country", new AbstractController.CustomEditorSupport("country"));
        binder.registerCustomEditor(Person.class, "person", new AbstractController.CustomEditorSupport("person"));
        binder.registerCustomEditor(Person.class, "operator", new AbstractController.CustomEditorSupport("person"));
        binder.registerCustomEditor(City.class, "city", new AbstractController.CustomEditorSupport("city"));
        binder.registerCustomEditor(Athlete.class, "athlete", new AbstractController.CustomEditorSupport("athlete"));
        binder.registerCustomEditor(Athlete.class, "chiefInstructor", new AbstractController.CustomEditorSupport("athlete"));
        binder.registerCustomEditor(Athlete.class, "athleteTariff.athlete", new AbstractController.CustomEditorSupport("athlete"));
        binder.registerCustomEditor(Team.class, "team", new AbstractController.CustomEditorSupport("team"));
        binder.registerCustomEditor(RegistrationRegion.class, "registrationRegion", new AbstractController.CustomEditorSupport("registrationRegion"));
        binder.registerCustomEditor(List.class, "instructors", new AbstractController.CustomEditorSupport("athletes"));
        binder.registerCustomEditor(Gym.class, "gym", new AbstractController.CustomEditorSupport("gym"));
        binder.registerCustomEditor(Gym.class, "athleteTariff.tariff.gym", new AbstractController.CustomEditorSupport("gym"));
        binder.registerCustomEditor(Coupon.class, "coupon", new AbstractController.CustomEditorSupport("coupon"));
        binder.registerCustomEditor(Tariff.class, "tariff", new AbstractController.CustomEditorSupport("tariff"));
        binder.registerCustomEditor(AthleteTariff.class, "athleteTariff", new AbstractController.CustomEditorSupport("athleteTariff"));
    }
