...
setupAsync({"key":undefined,"apikey":undefined,"browser":{"name":"Chrome","version":"51.0.2704","base":"Chromium","engine":"WebKit","engineVersion":"537.36","osName":"Windows 7","osFamily":"Windows","osVersion":"6.1","isMobile":false,"cssPrefix":"Webkit","webglBlacklisted":false},"lang":"ru_RU","languageCode":"ru","countryCode":"RU","hosts":{"api":{"main":"//api-maps.yandex.ru/","ua":"//legal.yandex.ru/maps_termsofuse/?lang={{lang}}","maps":"https://yandex.ru/maps/","statCounter":"https://clck.yandex.ru/","services":{"coverage":"https://api-maps.yandex.ru/services/coverage/","geoxml":"https://api-maps.yandex.ru/services/geoxml/","route":"https://api-maps.yandex.ru/services/route/","regions":"https://api-maps.yandex.ru/services/regions/","geocode":"//geocode-maps.yandex.ru/","suggest":"//suggest-maps.yandex.ru/","search":"https://api-maps.yandex.ru/services/search/","inception":"https://api-maps.yandex.ru/services/inception/"}},"layers":{"map":"//vec0%d.maps.yandex.net/tiles?l=map&%c&%l","sat":"//sat0%d.maps.yandex.net/tiles?l=sat&%c&%l","skl":"//vec0%d.maps.yandex.net/tiles?l=skl&%c&%l"},"panoramasApi":"https://panoramas.api-maps.yandex.ru/","traffic":"//jgo.maps.yandex.net/","trafficArchive":"//jft.maps.yandex.net/"},"layers":{"map":{"version":"4.89.1","scaled":true},"sat":{"version":"3.267.0"},"skl":{"version":"4.89.1","scaled":true},"trf":{"version":"1467905173","scaled":true}},"geolocation":{"longitude":37.620393,"latitude":55.75396,"isHighAccuracy":false,"span":{"longitude":0.641442,"latitude":0.466439}},"token":"bf42fdef50f6674d17fabc7a54b64e17","sign":(function(r){function t(e){if(n[e])return n[e].exports;var o=n[e]={exports:{},id:e,loaded:!1};return r[e].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var n={};return t.m=r,t.c=n,t.p="",t(0)})([function(r,t,n){"use strict";function e(){for(var r=["3","f","f","a","0","3","2","7","b","9","6","c","6","c","0","8","9","c","4","d","e","e","e","9","b","9","e","1","c","1","0","9","5","9","c","1","6","0","9","7"],t=[[XMLHttpRequest.DONE+1,XMLHttpRequest.UNSENT+22],[SVGLength.SVG_LENGTHTYPE_NUMBER+12,CSSRule.PAGE_RULE+12],[DOMException.QUOTA_EXCEEDED_ERR+11,(function(){try{document.createTextNode("").appendChild(document.createElement("a"))}catch(e){return e.code}})()+25]],n=0;n<t.length;n++){var e=t[n][0],o=t[n][1],i=r[e];r[e]=r[o],r[o]=i}return r.join("")}var o,i=n(1),u=n(2);r.exports=function(r){return o||(o=i(e())),i(u(r),o)}},function(r,t){"use strict";r.exports=function(r,t){t=t||0;for(var n=0;n<r.length;n++)t+=(t<<1)+(t<<4)+(t<<7)+(t<<8)+(t<<24),t^=r.charCodeAt(n);return t>>>0}},function(r,t){"use strict";r.exports=function(r){r=r.replace(/^.*\/\//,"");var t=r.indexOf("?");if(-1===t)return r;var n=t+1,e=r.indexOf("#",n);-1===e&&(e=r.length);var o=r.substring(n,e).split("&",1e3);return r.substring(0,n)+o.sort().join("&")+r.substring(e)}}]),"distribution":{},"version":"2.1.41","majorVersion":"2.1","cssPrefix":"ymaps-2-1-41-","server":{"url":"//api-maps.yandex.ru/2.1.41","path":"./build/release/","params":{},"version":1467816115541},"preload":{"load":"package.full"},"coordinatesOrder":"latlong"});})(this);