...
app.controller("NewsCtrl", function ($scope, CommonService, $routeParams, $rootScope) {
...
app.controller("StaticPageCtrl", function ($scope, CommonService, $routeParams, $rootScope) {
